...
def texto_tab2():
    return html.Div([
        ...
        html.P('Los datos utilizados en este estudio fueron obtenidos del Sistema de Vigilancia en Salud Pública de Colombia (SIVIGILA), el cual centraliza la notificación obligatoria de eventos de interés en salud pública, incluyendo el dengue y el dengue grave. Esta plataforma permite acceder a reportes anuales de casos clasificados por variables clínicas, demográficas, geográficas y temporales.', 
               style={'fontFamily': 'Lato', 'fontSize': '20px'}),
        html.P('Para este análisis se emplearon datos correspondientes al periodo comprendido entre los años 2013 y 2023, permitiendo capturar múltiples ciclos epidémicos e identificar patrones estacionales y regionales en la ocurrencia de la enfermedad. El enfoque se centró en la identificación de casos confirmados (por laboratorio o nexo epidemiológico) a partir de información asociada al paciente y su entorno clínico.', 
               style={'fontFamily': 'Lato', 'fontSize': '20px'})
    ])
